...
import {
  IPermissionSchema,
  isIPermissionSchema,
} from "../utils/model/IPermissionSchema";
...
const Admin = ({ user }) => {
  ...
  const handleAdd = (edit: InteractionProps) => {
    if (isIPermissionSchema(edit.updated_src)) {
      ...
      for (const [componentType, permissions] of Object.entries(
        edit.updated_src
      )) {
        ...
        if (permissions) {
          for (const [attributeName, attributePermission] of Object.entries(
            permissions
          )) {
            copy[componentType] = {
              ...copy[componentType],
              ...{ [attributeName]: !!attributePermission },
            };
          }
        }
      }
